...
##1. Descripción del dataset y limpieza de los datos
...
```
Comprobamos si existen nulos o espacios vacíos en el caso de las variables categóricas:
...
write.csv(titanic_without_na,"\titanic_limpio.csv",row.names = FALSE, col.names = TRUE)
